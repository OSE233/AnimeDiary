...
const AnimeDiary=() =>{
  return(
    ...
    <h1>
        Hello and welcome to my anime diary.
    </h1>
    <p>Oh sorry i didn't introduce myself,<br/>
      I'm Olatunji Oluwasemilore Emerald <br/>
      Temitope Tolulope Mayomikun and some<br/>
       other names.So here r the animes i <br/>
       watched in year 2025 enjoy .  
    </p> 
...
<p>
    This is one of my fav its came out last two years. Its an intresting anime about a girl<br/>
     ...
     anyways there real and they r hunting both of them. so they get other ppl entangled.   <br/>
     Jiji, Airia and Momos grandma seiko theres also this dunmass guy idk his name.
...
<p>
    ...
    power to him and now hes on a quest to destroy the creator of this power with the help of his<br/>
     set mates and pro heros.
</p>
...
<p>
    ...
    constantly reincarnate just to be the king.
</p>
